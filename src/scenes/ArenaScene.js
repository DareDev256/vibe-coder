...
export default class ArenaScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Kill streak combo system (extracted to ComboSystem)
    this.comboSystem = new ComboSystem(this, { decayMs: 3000 });
  ...
  createHUD() {
    ...
    // Kill streak combo HUD (managed by ComboSystem)
    this.comboSystem.createHUD(400, 95);
  ...
  playerDeath() {
    ...
    const lines = [
      ...
      { label: 'BEST STREAK', value: `${this.comboSystem.getBestStreak()}x`, color: '#ff00ff' },
    ];
